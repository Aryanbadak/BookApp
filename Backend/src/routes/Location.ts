...
router.get("/states/:countryId", async (req: Request, res: Response) => {
...
router.get("/cities/:stateId", async (req: Request, res: Response) => {
...
router.post("/countries", async (req: Request, res: Response) => {
  ...
  try {
    ...
    res.status(201).json({ message: "Country added", id: (result as any).insertId });
  } catch (error) {
...
router.post("/states", async (req: Request, res: Response) => {
  ...
  try {
    ...
    res.status(201).json({ message: "State added", id: (result as any).insertId });
  } catch (error) {
...
router.post("/cities", async (req: Request, res: Response) => {
  ...
  try {
    ...
    res.status(201).json({ message: "City added", id: (result as any).insertId });
  } catch (error) {
